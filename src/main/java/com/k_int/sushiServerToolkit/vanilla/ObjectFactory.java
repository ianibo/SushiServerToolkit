 ...
 * generated in the com.k_int.sushiServerToolkit.vanilla package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.k_int.sushiServerToolkit.vanilla
     * 
     */
