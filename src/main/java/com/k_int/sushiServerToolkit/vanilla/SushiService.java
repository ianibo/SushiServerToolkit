 ...
 * 2016-05-04T20:47:50.437+01:00
 * Generated source version: 3.1.3
 * 
 */
@WebServiceClient(name = "SushiService", 
                  wsdlLocation = "file:contracts/sushi/sushi1_7.wsdl",
...
public class SushiService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:contracts/sushi/sushi1_7.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SushiService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:contracts/sushi/sushi1_7.wsdl");
        }
        WSDL_LOCATION = url;
    }
    ...
    /**
     * Location is intentionally left blank for the client to fill in.
     *
     * @return
